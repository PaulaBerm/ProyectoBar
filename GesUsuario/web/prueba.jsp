<%-- 
    Document   : prueba
    Created on : 3/11/2020, 07:13:57 PM
    Author     : Paula
--%>
...
<html lang="en">
    ...
    <body class="alt-menu sidebar-noneoverflow">
                ...
                <nav id="sidebar">
                    ...
                    <ul class="navbar-nav theme-brand flex-row  text-center">
                        ...
                        <li class="nav-item theme-text">
                            <a href="index.html" class="nav-link"> INBAR </a>
                        </li>
                    </ul>
                    ...
                    <ul class="list-unstyled menu-categories" id="accordionExample">
                        ...
                        <li class="menu menu-heading">
                            <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span>Pedidos</span></div>
                        </li>
                        ...
                        <li class="menu menu-heading">
                            <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span>Ajustes</span></div>
                        </li>
        ...
        <script src="assets/js/libs/jquery-3.1.1.min.js"></script> <!--Pasado-->
        <script src="assets/js/popper.min.js"></script><!--Pasado cambiar ruta-->
        <script src="assets/js/bootstrap.min.js"></script><!--Pasado cambiar ruta-->
        <script src="plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script> <!--Pasado-->
        <script src="assets/js/app.js"></script> <!--Pasado-->
        <script>
            $(document).ready(function () {
                App.init();
            });
        </script>
        <script src="assets/js/custom.js"></script> <!--Pasado-->
        <!-- END GLOBAL MANDATORY SCRIPTS -->

        <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
        <script src="plugins/apex/apexcharts.min.js"></script> <!--Pasado-->
        <script src="assets/js/dashboard/dash_1.js"></script> <!--Pasado-->
        <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
