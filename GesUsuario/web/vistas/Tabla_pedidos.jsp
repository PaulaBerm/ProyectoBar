<%-- 
    Document   : Tabla_pedidos
    Created on : 01-nov-2020, 19:32:49
    Author     : cidra
--%>
               ...
               <ul class="navbar-nav theme-brand flex-row  text-center">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        <a href="vistas/Tabla_pedidos.jsp" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <div class="widget-content widget-content-area br-6">
                            <div class="table-responsive mb-4 mt-4">
                                <table id="html5-extension" class="multi-table table table-hover non-hover tablesorter" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th class="checkbox-column text-center"># Pedido</th>
                                            <th>Fecha de Ingreso</th>
                                            <th class="checkbox-column text-center">Total</th>
                                            <th>Cliente</th>
                                            <th>Empleado</th>
                                            <th class="checkbox-column text-center"># Mesa</th>
                                            <th>Estado</th>
                                        </tr>
                                    </thead>
                                    <tbody>
