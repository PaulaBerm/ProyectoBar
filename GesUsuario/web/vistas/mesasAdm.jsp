<%-- 
    Document   : mesasAdm
    Created on : 7/11/2020, 02:42:55 PM
    Author     : Paula
--%>
                ...
                <nav id="sidebar">
                    ...
                    <ul class="list-unstyled menu-categories" id="accordionExample">
                        ...
                        <li class="menu active">
                            <a href="Controlador?accion=mesas" aria-expanded="true" class="dropdown-toggle">
                                <div class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    <div class="" style="float:right;">
                                        <button type="button" class="btn btn-outline-primary mb-2 mr-2" data-toggle="modal" data-target="#agregar">Agregar</button>
                                    </div>
                                    <div class="table-responsive mb-4">
                                        <table id="style-3" class="table style-3  table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="checkbox-column text-center"> Número de Mesa </th>
                                                    <th>Capacidad</th>
                                                    <th>Estado</th>
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    List<mesaAdm> list = ped.infoMesas();
                                                    Iterator<mesaAdm> iter = list.iterator();
                                                ...
                                                %>
                                                <tr>
                                                    <td class="checkbox-column text-center"> <%= mesa.getNumero_mesa()%> </td>
                                                    <td><%= mesa.getCapacidad()%></td>
                                                    <td><%= mesa.getEstado()%></td>
                                                    <td class="text-center">
                                                        <ul class="table-controls">
                                                            <li><a href="javascript:void(0);" class="bs-tooltip" data-toggle="modal" data-target="#editar<%= mesa.getNumero_mesa()%>" data-placement="top" title="" data-original-title="Editar">
                                                            ...
                                                            <li>
                                                                <input type="hidden" id="txtNumero" name="txtNumero" value="<%= mesa.getNumero_mesa()%>"/>
                                                                <a href="Controlador?accion=eliminarMesa&id=<%= mesa.getNumero_mesa()%>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Eliminar" name="accion" value="eliminarMesa">
                                            ...
                                            <div id="editar<%= mesa.getNumero_mesa()%>" class="modal animated fadeInDown" role="dialog">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="${pageContext.request.contextPath}/Controlador" method="post">
                                                                <div class="form-group mb-4">
                                                                    <label for="">Mesa: <%= mesa.getNumero_mesa()%></label>

                                                                </div>
                                                                <div class="form-group mb-4">
                                                                    <label for="">Capacidad</label>
                                                                    <input type="text" class="form-control" maxlength="30" id="txtCapacidad" name="txtCapacidad" placeholder="Máximo 30 carácteres" value="<%= mesa.getCapacidad()%>">
                                                                </div>
                                                                <div class="form-group mb-4">
                                                                    <label for="">Estados</label>
                                                                    <select name="txtEstado" class="form-control">
                                                                        <option value="<%=mesa.getEstadoN()%>"> <%= mesa.getEstado()%></option>
                                                                        <%
                                                                            try {
                                                                                ResultSet rs = ped.mostrarEstados();
                                                                                if (!rs.next()) {
                                                                                    out.println("<OPTION VALUE=\"0\" SELECTED>No hay datos</OPTION>");
                                                                                } else {
                                                                                    do {
                                                                                        out.println("<OPTION VALUE=\"" + rs.getInt("id_estado") + "\">" + rs.getString("nombre_estado") + "</OPTION>");
                                                                                    } while (rs.next());
                                                                                }
                                                                            } catch (Exception e3) {
                                                                                out.println("<OPTION VALUE=\"0\" SELECTED>No hay datos</OPTION>");
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <div>
                                                                        <input type="hidden" id="txtNumero" name="txtNumero" value="<%= mesa.getNumero_mesa()%>"/>
                                                                        <button type="submit" class="btn btn-primary" name="accion" value="editarMesa">Enviar</button>
                                                                    </div>
                                                                </div>
                                                            </form> 
                                                        </div>
                                    ...
                                    <div id="agregar" class="modal animated fadeInDown" role="dialog">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="${pageContext.request.contextPath}/Controlador" method="post">
                                                        <label for="formGroupExampleInput" style="color: black">Número de mesa</label>
                                                        <div class="input-group form-group mb-4">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text" id="basic-addon5">#</span>
                                                            </div>
                                                            <input type="number" class="form-control" id="txtNumero" name="txtNumero" placeholder="Solo números">
                                                        </div>
                                                        <div class="form-group mb-4">
                                                            <label for="formGroupExampleInput2" style="color: black">Capacidad</label>
                                                            <input type="text" class="form-control" maxlength="30" id="txtCapacidad" name="txtCapacidad" placeholder="Máximo 30 carácteres">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Cancelar</button>
                                                            <button type="submit" class="btn btn-primary" name="accion" value="registrar">Enviar</button>
                                                        </div>
                                                    </form> 
                                                </div>
                                            </div>
