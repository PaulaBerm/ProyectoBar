<%-- 
    Document   : ajustesEmpl
    Created on : 29/09/2020, 04:05:02 PM
    Author     : Paula
--%>
                                    ...
                                    <div class="card-body">
                                        <form name="accion" action="ControladorEmp?accion=Guardar Cambios" method="post" class="formulario" id="formulario">
                                            ...
                                            <div class="formulario__grupo formulario__grupo-btn-enviar">
                                                ...
                                                <button type="submit" class="formulario__btn" name="accion" value="Guardar Cambios">Guardar Cambios</button>
